...
### **WORK IN PROGRESS**
* **Greift das Muster nicht, sagt die Legende über der Liste warum** — „Das Steckdose-Muster greift gerade nicht: SET fehlt“ — und ob eine nicht angehakte Zeile den Platz bekäme: „cmnd_POWER passt auf SET, ist aber nicht angehakt“, mit einem Knopf **anhaken**. Bisher stand nur „✕ SET fehlt“ im Musterfeld, und dass die passende Zeile bloß keinen Haken hatte, sah man nicht.
