...
### **WORK IN PROGRESS**
* Zeigt die Rolle einer Zeile auf einen Platz, den **schon eine andere Zeile hat**, sagt die Detailzeile das jetzt — „… → Platz SET — den hat schon cmnd_POWER“ — statt „SET verlangt boolean, eingestellt ist string“. Der alte Rat war schädlich: Wer ihm folgte, nahm dem Schaltpunkt den SET-Platz weg, und der Schalter konnte nicht mehr schalten.
