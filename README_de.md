...
### **WORK IN PROGRESS**
* In der Detailzeile gibt es jetzt **„Platz im Muster“**: Man wählt den Platz, etwa SET oder ACTUAL, und die Werkbank trägt ein, was das Muster dafür vorgibt — Rolle, Typ, Einheit, Werteliste. Bisher musste man wissen, dass SET die Rolle `switch` bedeutet. Belegte Plätze stehen ausgegraut mit ihrer Zeile daneben; verlangt ein Platz eine andere Schreibrichtung, sagt es ein Hinweis darunter.
